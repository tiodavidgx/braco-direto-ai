...
Obrigado.`,
  ...
  return (
    <div className="space-y-4 md:space-y-6">
      <div>
        <h1 className="text-2xl md:text-3xl font-bold text-foreground">Envio de Relatórios</h1>
        <p className="text-sm md:text-base text-muted-foreground">
          Enviar relatórios de fechamento para prestadores
        </p>
      </div>

      <Tabs defaultValue="manual" className="space-y-4 md:space-y-6">
        <TabsList className="grid w-full grid-cols-2">
          <TabsTrigger value="manual" className="text-xs sm:text-sm">Lançamento Manual</TabsTrigger>
          <TabsTrigger value="excel" className="text-xs sm:text-sm">Importar Excel</TabsTrigger>
        </TabsList>
          ...
          <Card>
            <CardHeader className="pb-4">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div>
                  <CardTitle className="text-lg md:text-xl">Adicionar Boletim Manualmente</CardTitle>
                  <CardDescription className="text-sm">Preencha os dados do serviço prestado</CardDescription>
                </div>
                <Button 
                  variant="outline" 
                  size="sm" 
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="grid grid-cols-3 gap-3 sm:gap-4">
                  ...
                  <div className="space-y-2">
                    <Label className="text-xs sm:text-sm">Valor Extra</Label>
                    <Input
                      type="number"
                      step="0.01"
